...
HTML::macro('wizard_previous', function($route, $parameters = array())
{
    $url = route($route, $parameters);
    return 
        '<a href="' 
        . $url 
        . '" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Previous</a>';
});

HTML::macro('wizard_next', function($parameters = array())
{
    return 
