...
<head>
    ...
    <title>Registration | Destiny Island | Causeway Coast Vineyard</title>

    <link rel="stylesheet" href="{{ asset('assets/stylesheets/registration.css') }}">
...
<body>
    ...
    <script src="{{ asset('assets/javascript/registration.js') }}"></script>
